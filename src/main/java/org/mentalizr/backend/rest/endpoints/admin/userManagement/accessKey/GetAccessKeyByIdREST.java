...
import org.mentalizr.serviceObjects.userManagement.UserGetByIdSO;
...
@Path("v1")
public class GetAccessKeyByIdREST {

    private static final String SERVICE_ID = "admin/user/accessKey/getById";
    ...
    public Response get(
        ...
        return new Service(httpServletRequest){
            ...
            protected AccessKeyRestoreSO workLoad() throws DataSourceException, EntityNotFoundException {
                return PatientAccessKeyGet.getById(userGetByIdSO.getId());
            }
