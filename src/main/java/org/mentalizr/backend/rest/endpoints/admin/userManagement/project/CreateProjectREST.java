...
public class CreateProjectREST {
    ...
    private static final String SERVICE_ID = "/admin/user/project/create";

    @POST
    @Path(SERVICE_ID)
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response create(ProjectSO projectSO,
        ...
        return new Service(httpServletRequest){
            ...
            protected void checkPreconditions() throws ServicePreconditionFailedException, M7rInfrastructureException {
                AssertProject.notExisting(projectSO.getProjectId());
            }

            @Override
            protected Object workLoad() throws DataSourceException {
                Project.add(projectSO.getProjectId(), projectSO.getLabel());
                return null;
            }
