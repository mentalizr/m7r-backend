...
public class DeleteTherapistREST {
    ...
    public Response delete(
        ...
        return new Service(httpServletRequest) {
            ...
            @Override
            protected Object workLoad() throws DataSourceException, EntityNotFoundException, BusinessConstraintException {
                ...
                if (!rolePatientVOList.isEmpty())
                    throw new BusinessConstraintException("Therapist has dependent patients.");
