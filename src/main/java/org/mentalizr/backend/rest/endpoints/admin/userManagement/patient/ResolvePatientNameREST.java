...
@Path("v1")
public class ResolvePatientNameREST {

    private static final String SERVICE_ID = "admin/user/patient/resolveName";

    @POST
    @Path(SERVICE_ID)
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response resolvePatientName(
        ...
        return new Service(httpServletRequest) {
            ...
            protected UserIdSO workLoad() throws DataSourceException, EntityNotFoundException {
                ...
                RolePatientDAO.load(userLoginVO.getUserId());
